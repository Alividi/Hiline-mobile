package com.example.hiline.user.layanan
...
class LayananRayaActivity : AppCompatActivity(), LayananRayaInterface {
        ...
        locationListener = object : LocationListener {
            override fun onLocationChanged(location: Location) {
                ...
                if (Latitude != 0.0 && Longitude != 0.0) {
                    ...
                    progressBar.visibility = View.VISIBLE
                    getHospital(latitude = Latitude, longitude = Longitude, page = 1)
                    rvLayananRaya = findViewById(R.id.rvLayananRaya)
                    layoutManager = LinearLayoutManager(this@LayananRayaActivity)
                    rvLayananRaya.layoutManager = layoutManager
                    adapter = LayananRayaUserAdapter(hospitalModels, this@LayananRayaActivity)
    ...
    fun getHospital(latitude: Double, longitude: Double, page: Int) {
        ...
        val call = service.getHospitals(latitude, longitude, 1999999999, "", keyword, page, 10, aToken)
