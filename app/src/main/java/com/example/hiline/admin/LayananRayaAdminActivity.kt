...
import com.example.hiline.adapter.LayananRayaAdminAdapter
...
class LayananRayaAdminActivity : AppCompatActivity(), LayananRayaInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = LayananRayaAdminAdapter(hospitalModels, this)
        ...
        locationListener = object : LocationListener {
            override fun onLocationChanged(location: Location) {
                ...
                Log.e("latitut , longitut list:", Latitude.toString()+","+Longitude.toString())
            }
            ...
            override fun onResponse(call: Call<HospitalsResponse>, response: Response<HospitalsResponse>) {
                if (response.isSuccessful) {
                    ...
                    hospitals?.forEach { hospital: HospitalsResponse.hospital ->
                        ...
                        rvLayananRaya.layoutManager = LinearLayoutManager(this@LayananRayaAdminActivity)
                    }
                } else {
                    val rawResponse = response.raw().toString()
                    Log.e("Raw Response: ", rawResponse)
